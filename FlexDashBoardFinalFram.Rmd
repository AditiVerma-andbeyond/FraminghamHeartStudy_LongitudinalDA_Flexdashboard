---
title: "Framingham Study Dashboard"
runtime: shiny
output: 
...
The package, Data Explorer, was used to visualize the summary of the data ( including the percentages of missing values), the distribution of the different types of data using histograms and QQ plots.
...
# Logistic Regression for predicting STROKE {data-navmenu="Logistic Regression Analysis"}
...
```{r, summary plots for full model:STROKE visit 1, fig.show="hold", out.width="50%"}
...
```{r, summary plots for full model:STROKE visit 2, fig.show="hold", out.width="50%"}
...
```{r, summary plots for full model:STROKE visit 3, fig.show="hold", out.width="50%"}
...
# Comparison of the models across criteria {data-navmenu="Logistic Regression Analysis"}
...
# Longitudinal analysis for Stroke
